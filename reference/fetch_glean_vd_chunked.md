...
Retrieve and parse VecDyn datasets specified by their dataset IDs in
batches.

This is not usually necessary (generally you just need
[`fetch_vd()`](https://ohvbd.vbdhub.org/reference/fetch_vd.md)) but
...
[`fetch_vd()`](https://ohvbd.vbdhub.org/reference/fetch_vd.md) and
[`glean_vd()`](https://ohvbd.vbdhub.org/reference/glean_vd.md) in your
own chunker instead.
