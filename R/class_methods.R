...
#' @param ... Any other arguments to be passed to the underlying fetch functions (see `get_vt()` and `get_vd()` for specific arguments).
...
#' get_ad(use_cache=TRUE) %>% extract(targetdate="2020-08-04")
#' }
